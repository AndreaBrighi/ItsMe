...
class HomeFragment(private val config: Boolean = false) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sectionsPagerAdapter = SectionsPagerAdapter(this.requireActivity(), config)
...
//        }
    ...
    override fun onResume() {
        super.onResume()
        if(config)
            requireActivity().findViewById<FloatingActionButton>(com.example.itsme.R.id.fab_check).isEnabled=false
    }
}